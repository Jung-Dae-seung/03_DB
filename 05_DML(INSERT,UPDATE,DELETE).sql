...
VALUES('900', '정대승', '991215-1234567', 
  'hong_gd@or.kr', '01011111111', 
...
-- 2) INSERT INTO 테이블명 (컬럼명1, 컬럼명2, 컬럼명...)
-- 								VALUES (데이터1, 데이터2, 데이터...)
-- 테이블에 내가 선택한 컬럼에 대한 값만 INESRT 할 때 사용
-- 선택 안된 컬럼은 값이 NULL이 들어감 (DEFAULT 존재 시 DEFAULT 설정값으로 삽입됨)

INSERT INTO EMPLOYEE2 (EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE,
												DEPT_CODE, JOB_CODE, SAL_LEVEL, SALARY)
								VALUES('900', '홍길동', '991215-1234567', 'hong_gd@or.kr', '01011111111', 
	'D1', 'J7', 'S3', 4300000);
